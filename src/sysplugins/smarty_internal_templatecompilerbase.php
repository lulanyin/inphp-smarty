...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    public function callTagCompiler($tag, $args, $param1 = null, $param2 = null, $param3 = null)
    {
        ...
        // unknown tag, then find the tag from function library to compile // 2014.07.22
        return $this->compileTagFromLibrary($tag, $args);
    }

    /**
     * compile tag from function library
     * @param string $tag
     * @param array $args
     * @return array|string
     * 2014.07.22
    ...
    public function compileTagFromLibrary($tag, $args)
    {
        if(!empty($tag))
        {
            ...
            if(@require_once($cache_compiler))
            {
                ...
                {
                    self::$_tag_objects[$tag] = new $class_name;
                    //$_attr = self::$_tag_objects[$tag]->getAttributes($this, $args);
                    return self::$_tag_objects[$tag]->compile($args, $this);
                }
            }
        }
